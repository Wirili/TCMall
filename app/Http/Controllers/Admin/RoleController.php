...
class RoleController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->breadcrumb[]=['url'=>\URL::route('admin.role.index'),'title'=>trans('admin/role.list')];
    }
    ...
    public function index()
    {
        ...
        return view('admin.role.index',[
            'page_title'=>trans('admin/role.list'),
    ...
    public function edit($id)
    {
        ...
        $this->breadcrumb[]=['url'=>'javascript:void(0)','title'=>trans('admin/role.edit')];
        $role = Role::find($id);
        ...
        return view('admin.role.edit', [
            'page_title'=>trans('admin/role.edit'),
            'breadcrumb'=>$this->breadcrumb,
            'role' => $role,
    ...
    public function create()
    {
        ...
        $this->breadcrumb[]=['url'=>'javascript:void(0)','title'=>trans('admin/role.create')];
        $role = new Role();
        $permission = Permission::where('parent_id',0)->get();
        $perms=[];
        return view('admin.role.edit', [
            'page_title'=>trans('admin/role.create'),
            'breadcrumb'=>$this->breadcrumb,
            'role' => $role,
            'permission'=>$permission,
            'perms'=>$perms
    ...
    public function del($id)
    {
        ...
        if($role&&$role->users->isEmpty()) {
                $role->delete();
                return $this->Msg(trans('admin/role.del_success'),\URL::route('admin.role.index'));
        }else
            return $this->Msg(trans('admin/role.del_fail'),\URL::route('admin.role.index'),'error');
    }
    ...
    public function save(Request $request)
    {
        ...
        return $this->Msg(trans('admin/role.save_success'),\URL::route('admin.role.index'));
    }
