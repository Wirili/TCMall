    ...
    <form class="form-horizontal" role="form" method="POST" action="{{ URL::route('admin.admin.save') }}">
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">@lang('admin/admin.tab_basic')</a></li>
                <li role="presentation"><a href="#tab_permission" aria-controls="tab_permission" role="tab" data-toggle="tab">@lang('admin/admin.tab_permission')</a></li>
            </ul>
            ...
            <div class="tab-content" style="margin-top: 8px;">
                ...
                <div role="tabpanel" class="tab-pane" id="tab_permission">
                    <div class="form-group">
                        <label class="col-md-2 control-label">@lang('admin/admin.permission')</label>
                        <div class="col-md-6">
